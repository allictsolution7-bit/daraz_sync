...
class WooCommerceMigrateCategories extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'woocommerce:migrate-categories {--dry-run : Run without making changes}';
     ...
     * @var string
     */
    protected $description = 'Migrate categories from WooCommerce';
    ...
    public function handle()
    {
        ...
        $stats = $migrationService->migrateCategories($dryRun);

        $bar->finish();
        $this->newLine(2);

        $this->displayStats('Categories', $stats);
