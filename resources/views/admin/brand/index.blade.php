...
@section('styles')
    ...
    <style>
        ...
        /* Elegant Brand Logo Image Frame */
    ...
    <div class="container categories-container">
        ...
        <div class="glass-card">
            ...
            <div class="row align-items-center mb-4">
                <div class="col-md-6">
                    <h1 class="page-header-title">Brands Directory</h1>
                    <p class="page-header-subtitle">Manage store brand names, slugs, logos, publishing status and links.</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <div class="action-toolbar justify-content-md-end">
                        <button type="button" id="deleteSelectedBrands" class="btn-delete-selected" disabled>
                            <i class="fa-solid fa-trash-can"></i> Delete Selected
                        </button>
                        <a href="{{ route('admin.brands.create') }}" class="btn-add-category">
            ...
            <div class="premium-table-wrapper">
                <table class="table premium-table" id="brands">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($brands as $brand)
                            <tr>
                                ...
                                <td class="font-monospace text-muted">#{{ $brand->id }}</td>
                                <td></td>
                                <td>
                                    @if($brand->logo)
                                ...
                                <td class="fw-semibold text-slate-800">{{ $brand->name }}</td>
                                <td class="text-muted">{{ $brand->slug }}</td>
                                <td>
                                    <span class="status-pill {{ $brand->status ? 'status-active' : 'status-inactive' }}">
                                        {{ $brand->status ? 'Active' : 'Inactive' }}
                                    </span>
                                </td>
                                <td class="text-secondary">{{ $brand->created_at->format('M d, Y') }}</td>
                                <td class="text-end">
                                    <div class="d-inline-flex gap-1" role="group">
                                        <a href="{{ route('admin.brands.edit', $brand) }}" 
                                           class="btn-action-custom btn-action-edit" title="Edit Brand">
                                        ...
                                        <form action="{{ route('admin.brands.destroy', $brand) }}" 
                                            ...
                                            <button type="submit" class="btn-action-custom btn-action-delete" 
                                                    title="Delete Brand" onclick="return confirm('Are you sure you want to delete this brand?')">
