        ...
        <div class="glass-card">
            ...
            <div class="row align-items-center mb-4">
                <div class="col-md-6">
                    ...
                    <p class="page-header-subtitle">Manage and organize your catalog categories, views, and visual representations.</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <div class="action-toolbar justify-content-md-end">
                        <button type="button" id="deleteSelectedCategories" class="btn-delete-selected" disabled>
                            <i class="fa-solid fa-trash-can"></i> Delete Selected
                        </button>
                        <a href="{{ route('admin.product_categories.create') }}" class="btn-add-category">
            ...
            <div class="premium-table-wrapper">
                <table class="table premium-table" id="categories">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td class="font-monospace text-muted">#{{ $category->id }}</td>
                                <td></td>
                                <td>
                                    @if($category->image)
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-1" role="group">
                                        <a href="{{ route('admin.product_categories.edit', $category->id) }}" 
                                           class="btn-action-custom btn-action-edit" title="Edit Category">
