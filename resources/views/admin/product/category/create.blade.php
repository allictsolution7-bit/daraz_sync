    ...
    <div class="container categories-container">
        ...
        <nav aria-label="breadcrumb" class="custom-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.product_categories.index') }}">Categories</a></li>
        ...
        <div class="glass-card">
            <!-- Header Section -->
            <div class="mb-4">
                <h1 class="page-header-title">Create Product Category</h1>
                <p class="page-header-subtitle">Configure basic details, image banners, status parameters, and SEO optimization targets.</p>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="form-section-card">
                            ...
                            <p class="form-section-subtitle">Manage category name, auto-slug generation, descriptions, and file uploads.</p>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{ old('name') }}" placeholder="e.g., Electronics or Gadgets" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="slug-input-wrapper">
                                    <input type="text" class="form-control" id="slug" name="slug"
                                        value="{{ old('slug') }}" placeholder="e.g., electronics-or-gadgets" required>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="4" 
                                    placeholder="Enter a brief description of the products falling under this category...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="text-error-small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="background_image" class="form-label">Category Banner</label>
                            ...
                            <div class="mb-3 mt-2">
                                ...
                                <select class="form-select" id="status" name="status" required>
                                    <option value="active" {{ old('status', 'active') == 'active' ? 'selected' : '' }}>Active (Publish Live)</option>
                                    <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>Inactive (Save Draft)</option>
                                </select>
                                <small class="form-text text-muted mt-1 d-block">Published categories appear on the store shop front immediately.</small>
                                @error('status')
                                    <div class="text-error-small">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-lg-5">
                        <div class="form-section-card">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="meta_keywords" name="meta_keywords"
                                    value="{{ old('meta_keywords') }}" placeholder="Comma separated keywords e.g. gadgets, tech, accessories">
                                @error('meta_keywords')
                                    <div class="text-error-small">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 mt-4">
                            <a href="{{ route('admin.product_categories.index') }}" class="btn-back-premium">
