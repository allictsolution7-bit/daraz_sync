                            ...
                            <div class="mt-4 pt-3 border-top">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="return_period" class="form-control" placeholder="0" min="0" value="{{ old('return_period', $product->return_period ?? 0) }}">
        ...
        if (productCostInput) {
            ...
            if (!isNaN(initialCost) && initialCost > 0) {
                if (salePriceInput && (!salePriceInput.value || parseFloat(salePriceInput.value) <= 0)) {
                    salePriceInput.value = (initialCost * (1 + pricingPercentages.sale / 100)).toFixed(2);
                }
                if (oldPriceInput && (!oldPriceInput.value || parseFloat(oldPriceInput.value) <= 0)) {
                    oldPriceInput.value = (initialCost * (1 + pricingPercentages.old / 100)).toFixed(2);
                }
                if (wholesalePriceInput && (!wholesalePriceInput.value || parseFloat(wholesalePriceInput.value) <= 0)) {
                    wholesalePriceInput.value = (initialCost * (1 + pricingPercentages.wholesale / 100)).toFixed(2);
                }
                if (resellerPriceInput && (!resellerPriceInput.value || parseFloat(resellerPriceInput.value) <= 0)) {
                    resellerPriceInput.value = (initialCost * (1 + pricingPercentages.reseller / 100)).toFixed(2);
                }
                if (globalPriceInput && (!globalPriceInput.value || parseFloat(globalPriceInput.value) <= 0)) {
                    globalPriceInput.value = (initialCost * (1 + pricingPercentages.global / 100)).toFixed(2);
                }
            }
