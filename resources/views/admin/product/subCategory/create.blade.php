...
@section('content')
    <div class="container-fluid mt-5 py-5">
        ...
        <form action="{{ route('admin.sub-categories.store') }}" method="POST" enctype="multipart/form-data" class="mt-1 mb-3">
            @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="imagePreview" class="mt-2" style="display: none;">
                                <img src="" alt="SubCategory Image Preview" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                            </div>
                            @error('image')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">Subcategories are published as Active by default. Select Inactive if you want to save as draft.</small>
                            @error('status')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
