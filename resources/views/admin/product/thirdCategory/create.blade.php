...
@section('content')
    <div class="container-fluid mt-5 py-5">
        ...
        <h5>Add Third Level Category</h5>
        ...
        <form action="{{ route('admin.third-categories.store') }}" method="POST" enctype="multipart/form-data" class="mt-1 mb-3">
            @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                   value="{{ old('name') }}" placeholder="Third Category name" required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <div id="bannerImagePreview" class="mt-2" style="display: none;">
                                <img src="" alt="Background Image Preview" class="img-thumbnail" style="max-width: 300px; max-height: 150px;">
                            </div>
            ...
            <button type="submit" class="btn btn-primary">Create Third Category</button>
