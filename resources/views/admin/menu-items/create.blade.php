        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Add Menu Item to {{ $menu->name }}</h5>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.menus.items.store', $menu) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="icon_class" id="icon_class" class="form-control @error('icon_class') is-invalid @enderror" value="{{ old('icon_class') }}">
