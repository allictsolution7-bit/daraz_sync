...
<div id="schedules-page" class="container-fluid px-4 py-4">
    ...
    <div class="hdr-panel">
        <div class="hdr-title">
            <h4>Create Backup Schedule</h4>
            <p>Define schedule details, storage target, and cron interval patterns</p>
        </div>
    ...
    <div class="module-wrap">
        <div class="section-band">
            <div class="band-icon"><i class="fas fa-calendar-plus"></i></div>
            <div>
                <h2>Schedule Parameters</h2>
                <span>Create a new automated cron profile</span>
            </div>
        </div>
                ...
                <div class="option-grid-2" style="margin-bottom: 20px;">
                    <div>
                        ...
                        <input type="text" name="name" class="field-input @error('name') is-invalid @enderror" 
                            value="{{ old('name') }}" placeholder="e.g. Daily Database Backup" required>
                    ...
                    <div>
                        ...
                        <div class="toggle-row" style="margin-bottom:0;">
                            ...
                            <div class="toggle-wrap">
                                <input class="premium-toggle" type="checkbox" name="is_active" id="is_active" value="1" checked>
