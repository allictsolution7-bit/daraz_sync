                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="reviewer_name" id="reviewer_name" class="form-control" value="{{ old('reviewer_name', $review->reviewer_name) }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($review->reviewer_image)
                                        <div class="mb-2">
                                            <img src="{{ asset($review->reviewer_image) }}" alt="{{ $review->reviewer_name }}" class="img-thumbnail" width="100">
                                        </div>
                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="review_date" id="review_date" class="form-control" value="{{ old('review_date', $review->review_date->format('Y-m-d')) }}" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_name" id="product_name" class="form-control" value="{{ old('product_name', $review->product_name) }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @if($review->product_image)
                                        <div class="mb-2">
                                            <img src="{{ asset($review->product_image) }}" alt="{{ $review->product_name }}" class="img-thumbnail" width="100">
                                        </div>
                                    @endif
                                    <div class="custom-file">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="review_text" id="review_text" rows="5" class="form-control" required>{{ old('review_text', $review->review_text) }}</textarea>
                                </div>
                                
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', $review->is_active) ? 'checked' : '' }}>
