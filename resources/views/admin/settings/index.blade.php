                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="settings[default_badge_text]" class="form-control"
                                value="{{ setting('general', 'default_badge_text', '১০% ছাড়') }}"
                                placeholder="১০% ছাড়">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="settings[additional_related_products_section_title]" class="form-control"
                                    value="{{ setting('general', 'additional_related_products_section_title', 'আরও দেখুন') }}" placeholder="আরও দেখুন">
                                <small class="form-text text-muted">Title for the additional related products section (e.g., "আরও দেখুন", "See More", "Related Products").</small>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="settings[pages_label_text]" class="form-control"
                                    value="{{ setting('general', 'pages_label_text', 'পৃষ্ঠা') }}" placeholder="পৃষ্ঠা">
                                <small class="form-text text-muted">Text label for the pages field (e.g., "পৃষ্ঠা", "Pages", "পেজ").</small>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <small class="form-text text-muted">Text label for the language field (e.g., "ভাষা", "Language", "ল্যাঙ্গুয়েজ").</small>
                            </div>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="settings[related_products_section_title]" class="form-control"
                                    value="{{ setting('general', 'related_products_section_title', 'আরও দেখুন') }}" placeholder="আরও দেখুন">
                                <small class="form-text text-muted">Title for the related products section (e.g., "আরও দেখুন", "See More", "Related Products").</small>
                            </div>
                        </div>
                    </div>
                </div>
