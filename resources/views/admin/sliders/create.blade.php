...
<div id="sliders-page" class="container-fluid px-4 py-4">
    ...
    <div class="hdr-panel">
        <div class="hdr-title">
            ...
            <p>Setup homepage banners with headings, buttons, links, and opacity overlays</p>
        </div>
    ...
    <div class="module-wrap">
        <div class="section-band">
            ...
            <div>
                ...
                <span>Create a new slide element</span>
            </div>
        </div>
                ...
                <div class="option-grid-2">
                    ...
                    <div>
                        <div style="margin-bottom:16px;">
                            ...
                            <input type="text" class="field-input @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. Premium Deals">
                        ...
                        <div style="margin-bottom:16px;">
                            ...
                            <textarea class="field-textarea @error('description') is-invalid @enderror" id="description" name="description" placeholder="e.g. Save up to 50% on selected electronic accessories">{{ old('description') }}</textarea>
                        ...
                        <div class="option-grid-2" style="gap:16px; margin-bottom:16px;">
                            <div>
                                ...
                                <input type="text" class="field-input @error('button_text') is-invalid @enderror" id="button_text" name="button_text" value="{{ old('button_text') }}" placeholder="e.g. Shop Now">
                                @error('button_text')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div>
                                <label class="field-label">Button URL</label>
                                <input type="text" class="field-input @error('button_url') is-invalid @enderror" id="button_url" name="button_url" value="{{ old('button_url') }}" placeholder="e.g. https://domain.com/shop">
                    ...
                    <div>
                        <div style="margin-bottom:16px;">
                            ...
                            <input type="file" class="field-input @error('image') is-invalid @enderror" id="image" name="image" required style="padding-top:8px;">
                            <div class="field-hint">Recommended size: 1920x550 pixels (JPG/PNG format)</div>
                            @error('image')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div style="margin-bottom:16px;">
                            <label class="field-label">Image Alt Text</label>
                            <input type="text" class="field-input @error('image_alt') is-invalid @enderror" id="image_alt" name="image_alt" value="{{ old('image_alt') }}" placeholder="e.g. Banner promo image">
                        ...
                        <div class="option-grid-2" style="gap:16px; margin-bottom:16px;">
                            <div>
                                ...
                                <div class="input-group-premium">
                                    <input type="text" class="field-input @error('overlay_color') is-invalid @enderror" id="overlay_color" name="overlay_color" value="{{ old('overlay_color', 'rgba(0, 0, 0, 0.4)') }}">
                        ...
                        <div class="option-grid-2" style="gap:16px; margin-bottom:16px; align-items: center;">
                            <div>
                                ...
                                <input type="number" class="field-input @error('position') is-invalid @enderror" id="position" name="position" value="{{ old('position', 0) }}" min="0">
                            ...
                            <div>
                                ...
                                <div class="toggle-row" style="margin-bottom:0; padding:10px 14px;">
                                    ...
                                    <div class="toggle-wrap">
                                        <input class="premium-toggle" type="checkbox" name="status" id="status" value="1" {{ old('status') ? 'checked' : '' }}>
