...
<div class="container-fluid px-4 py-4">
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1 small">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.users') }}" class="text-decoration-none text-muted">Users & Accounts</a></li>
                    <li class="breadcrumb-item active text-primary font-weight-semibold" aria-current="page">Create New User</li>
                </ol>
            </nav>
            <h4 class="font-weight-bold text-dark mb-0"><i class="fas fa-user-plus text-primary me-2"></i> Add New User Account</h4>
        </div>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-7 col-12">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="input-icon-group">
                                    ...
                                    <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone') }}" placeholder="+8801700000000">
                                </div>
                            </div>
                            <div class="col-md-6 col-12 d-flex align-items-end">
                                <div class="form-check form-switch p-3 bg-light rounded-3 border w-100 d-flex align-items-center justify-content-between m-0">
                                    <div>
                                        ...
                                        <div class="text-muted" style="font-size: 10px;">Mark mobile/account as verified</div>
                                    </div>
                                    <input class="form-check-input ms-3" type="checkbox" role="switch" id="otp_verified" name="otp_verified" value="1" {{ old('otp_verified') ? 'checked' : '' }} style="cursor: pointer; width: 40px; height: 20px;">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-card">
                    <div class="form-card-header">
                        <h6 class="mb-0 font-weight-bold text-dark"><i class="fas fa-lock text-warning me-2"></i> Account Security & Password</h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6 col-12">
            ...
            <!-- Right Column: Role Assignment & Location -->
            <div class="col-lg-5 col-12">
                <!-- Role Assignment Card -->
                <div class="form-card mb-4">
                    <div class="form-card-header">
                        <h6 class="mb-0 font-weight-bold text-dark"><i class="fas fa-user-shield text-info me-2"></i> Role & Access Level</h6>
                    </div>
                    <div class="card-body p-4">
                        @php
                            $availableRoles = isset($allRoles) ? $allRoles : \Spatie\Permission\Models\Role::all();
                            ...
                            $oldRoles = old('roles', ['customer']);
                        @endphp
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <label class="form-label font-weight-semibold text-dark small mb-0">Select Account Roles</label>
                            <span class="badge bg-primary text-white rounded-pill px-2.5 py-1" style="font-size: 10px;">{{ count($availableRoles) }} available</span>
                        </div>
                        
                        <div class="row g-2 mb-3" style="max-height: 320px; overflow-y: auto; padding-right: 4px;">
                            @foreach($availableRoles as $roleObj)
                                @php
                                    $rName = $roleObj->name;
                                    $isSelected = in_array($rName, (array)$oldRoles);
                        ...
                        <div class="p-2.5 bg-light rounded-3 border">
                            ...
                            <p class="text-muted mb-0" style="font-size: 11px;">Select one or multiple roles to assign all corresponding permissions to this new user account.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <div class="input-icon-group">
                                ...
                                <input type="text" class="form-control" id="address" name="address" value="{{ old('address') }}" placeholder="House #, Street, Area">
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-6">
                                ...
                                <div class="input-icon-group">
                                    ...
                                    <input type="text" class="form-control" id="upazila" name="upazila" value="{{ old('upazila') }}" placeholder="e.g. Mirpur">
                                </div>
                            </div>
                            <div class="col-6">
