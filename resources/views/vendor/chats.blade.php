    ...
    <div class="chat-sidebar">
        ...
        <div class="chat-list">
            @forelse($chatRooms as $room)
                <a href="{{ route('vendor.chats.index', ['room' => $room->id]) }}" 
            ...
            @empty
                <div class="p-5 text-center text-muted text-sm">
        ...
        @if($activeRoom)
            <div class="chat-room-container">
                <div class="chat-header">
                    <a href="{{ route('vendor.chats.index') }}" class="d-md-none text-slate-600 me-2">
