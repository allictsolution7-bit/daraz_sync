...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('vendor.dashboard') }}">
                <i class="fas fa-shop"></i> Vendor Panel
            </a>
    ...
    <div class="container-fluid py-4">
        @if(!auth()->user()->vendorSettings->is_verified)
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <i class="fas fa-exclamation-triangle"></i>
                <strong>Verification Pending:</strong> Your vendor account is awaiting admin verification. Some features may be limited.
