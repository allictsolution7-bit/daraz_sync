...
@section('content')
    ...
    <section class="blog-banner text-center text-white py-5">
        <div class="container">
            <h1>Posts Tagged with "{{ ucfirst($tag) }}"</h1>
            <p class="lead">
                Explore our articles tagged with "{{ $tag }}"<br>
                Find tips, insights, and information about books and publishing.
            </p>
        </div>
    </section>
    ...
    <section class="blog-archive">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="post-area">
                        <h2 class="section-title">Posts Tagged with "{{ ucfirst($tag) }}"</h2>
                            ...
                            @else
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        ...
                                        <p>Try searching for different tags or browse our <a href="{{ route('blog.index') }}">blog categories</a>.</p>
                                    </div>
                                </div>
                            @endif
                        </div>
